import {
  ...
  RouterLinkActive,
  RouterModule
} from "./chunk-RIISBBSN.js";
import "./chunk-X5TN2P7Q.js";
import {
  EventBus,
  FilterMatchMode,
  PrimeTemplate,
...
var dtwt = (theme6 = {}, tokenPath, fallback, type) => {
  if (tokenPath) {
    const {
      variable: VARIABLE,
      options: OPTIONS
    ...
    const {
      prefix,
      transform
    } = (theme6 == null ? void 0 : theme6.options) || OPTIONS || {};
    const regex = /{([^}]*)}/g;
...
function toVariables_default(theme6, options = {}) {
...
var themeUtils_default = {
  ...
  _toVariables(theme6, options) {
    return toVariables_default(theme6, {
...
var config_default = {
  ...
  update(newValues = {}) {
    ...
    if (theme6) {
      this._theme = __spreadProps2(__spreadValues2({}, theme6), {
        options: __spreadValues2(__spreadValues2({}, this.defaults.options), theme6.options)
      });
...
var ThemeProvider = class _ThemeProvider {
  ...
  setThemeConfig(config) {
    ...
    if (theme6) this.theme.set(theme6);
...
var BaseComponent = class _BaseComponent {
  ...
  cx(arg, rest) {
    const classes5 = this.parent ? this.parent.componentStyle?.classes?.[arg] : this.componentStyle?.classes?.[arg];
    if (typeof classes5 === "function") {
      return classes5({
        instance: this
      });
    }
    return typeof classes5 === "string" ? classes5 : arg;
  }
  sx(arg) {
...
var Badge = class _Badge extends BaseComponent {
  ...
  containerClass = computed(() => {
    let classes5 = "p-badge p-component";
    if (isNotEmpty(this.value()) && String(this.value()).length === 1) {
      classes5 += " p-badge-circle";
    }
    if (this.badgeSize() === "large") {
      classes5 += " p-badge-lg";
    ...
    if (isEmpty(this.value())) {
      classes5 += " p-badge-dot";
    }
    if (this.styleClass()) {
      classes5 += ` ${this.styleClass()}`;
    }
    if (this.severity()) {
      classes5 += ` p-badge-${this.severity()}`;
    }
    return classes5;
  });
  static ɵfac = /* @__PURE__ */ (() => {
...
.p-menubar {
    display: flex;
    align-items: center;
    background: ${dt2("menubar.background")};
    border: 1px solid ${dt2("menubar.border.color")};
    border-radius: ${dt2("menubar.border.radius")};
    color: ${dt2("menubar.color")};
    padding: ${dt2("menubar.padding")};
    gap: ${dt2("menubar.gap")};
}
...
.p-menubar-root-list > .p-menubar-item > .p-menubar-item-content {
    border-radius: ${dt2("menubar.base.item.border.radius")};
}

.p-menubar-root-list > .p-menubar-item > .p-menubar-item-content > .p-menubar-item-link {
    padding: ${dt2("menubar.base.item.padding")};
}

.p-menubar-item-content {
    transition: background ${dt2("menubar.transition.duration")}, color ${dt2("menubar.transition.duration")};
    border-radius: ${dt2("menubar.item.border.radius")};
    color: ${dt2("menubar.item.color")};
}
...
.p-menubar-item-link {
    ...
    position: relative;
    color: inherit;
    padding: ${dt2("menubar.item.padding")};
    gap: ${dt2("menubar.item.gap")};
    user-select: none;
    outline: 0 none;
}
...
.p-menubar-item-icon {
    color: ${dt2("menubar.item.icon.color")};
}

.p-menubar-submenu-icon {
    color: ${dt2("menubar.submenu.icon.color")};
    margin-left: auto;
    font-size: ${dt2("menubar.submenu.icon.size")};
    width: ${dt2("menubar.submenu.icon.size")};
    height: ${dt2("menubar.submenu.icon.size")};
}
...
.p-menubar-item.p-focus > .p-menubar-item-content {
    color: ${dt2("menubar.item.focus.color")};
    background: ${dt2("menubar.item.focus.background")};
}

.p-menubar-item.p-focus > .p-menubar-item-content .p-menubar-item-icon {
    color: ${dt2("menubar.item.icon.focus.color")};
}

.p-menubar-item.p-focus > .p-menubar-item-content .p-menubar-submenu-icon {
    color: ${dt2("menubar.submenu.icon.focus.color")};
}
...
.p-menubar-item-active > .p-menubar-item-content {
    color: ${dt2("menubar.item.active.color")};
    background: ${dt2("menubar.item.active.background")};
}

.p-menubar-item-active > .p-menubar-item-content .p-menubar-item-icon {
    color: ${dt2("menubar.item.icon.active.color")};
}

.p-menubar-item-active > .p-menubar-item-content .p-menubar-submenu-icon {
    color: ${dt2("menubar.submenu.icon.active.color")};
}
...
.p-menubar-submenu {
    ...
    min-width: 12.5rem;
    z-index: 1;
    background: ${dt2("menubar.submenu.background")};
    border: 1px solid ${dt2("menubar.submenu.border.color")};
    border-radius: ${dt2("menubar.border.radius")};
    box-shadow: ${dt2("menubar.submenu.shadow")};
    color: ${dt2("menubar.submenu.color")};
    flex-direction: column;
    padding: ${dt2("menubar.submenu.padding")};
    gap: ${dt2("menubar.submenu.gap")};
}

.p-menubar-submenu .p-menubar-separator {
    border-top: 1px solid ${dt2("menubar.separator.border.color")};
}
...
.p-menubar-button {
    ...
    align-items: center;
    cursor: pointer;
    width: ${dt2("menubar.mobile.button.size")};
    height: ${dt2("menubar.mobile.button.size")};
    position: relative;
    color: ${dt2("menubar.mobile.button.color")};
    border: 0 none;
    background: transparent;
    border-radius: ${dt2("menubar.mobile.button.border.radius")};
    transition: background ${dt2("menubar.transition.duration")}, color ${dt2("menubar.transition.duration")}, outline-color ${dt2("menubar.transition.duration")};
    outline-color: transparent;
}

.p-menubar-button:hover {
    color: ${dt2("menubar.mobile.button.hover.color")};
    background: ${dt2("menubar.mobile.button.hover.background")};
}

.p-menubar-button:focus-visible {
    box-shadow: ${dt2("menubar.mobile.button.focus.ring.shadow")};
    outline: ${dt2("menubar.mobile.button.focus.ring.width")} ${dt2("menubar.mobile.button.focus.ring.style")} ${dt2("menubar.mobile.button.focus.ring.color")};
    outline-offset: ${dt2("menubar.mobile.button.focus.ring.offset")};
}
...
.p-menubar-mobile .p-menubar-submenu {
    ...
    box-shadow: none;
    border: 0 none;
    padding-left: ${dt2("menubar.submenu.mobile.indent")};
}
`;
var classes4 = {
  root: ({
